...
ASP.NET Core는 개발, 스테이징, 운영서버를 운영하는 다중 환경에서 애플리케이션의 행동을 환경에 맞게 조정하기 위한 개선된 방안을 소개하고 있다. 환경 변수(environment variables)는 앱이 적절히 구성되도록 앱이 운영되는 환경을 나타내기 위해 사용된다.
